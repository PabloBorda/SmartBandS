...
public class MenuActivity extends Activity {
     ...
     private class FacebookRetriever extends AsyncTask<Void,String,String>{
        ...
        protected void onProgressUpdate(String... res){
         ...
         private void create_xmpp_account(){
            ...
            String response = Util.get("http://soa1.papitomarket.com:9494/newxmpp?uid=" + jabber_username);
    ...
    public void onCreate(Bundle icicle) {
        ...
        settings_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                Intent settings_screen = new Intent(getApplicationContext(),SearchActivity.class);
                startActivity(settings_screen);
            }
        });

        ImageButton sell_button = (ImageButton)findViewById(R.id.sell_button);
        sell_button.setOnClickListener(new View.OnClickListener() {

            public void onClick(View arg0) {
                Intent sell_screen = new Intent(getApplicationContext(),SellActivity.class);
                startActivity(sell_screen);
            }
        });
        
        ImageButton buycredit_button = (ImageButton)findViewById(R.id.buycredit_button);
        ...
        ImageButton invite_button = (ImageButton)findViewById(R.id.invite_button);
        invite_button.setOnClickListener(new View.OnClickListener() {

            public void onClick(View arg0) {
                Intent invite_screen = new Intent(getApplicationContext(),ContactListActivity.class);
